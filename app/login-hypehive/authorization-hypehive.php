...
<head>
    ...
    <link rel="stylesheet" href="authorization-hypehive.css">
    <script src="authorization-hypehive.js"></script>
</head>
...
<body>
    <div class="container">
        ...
        <div class="logo">
            ...
            <img 
                class="logo-hype"
                src="../assets/images/img_hypehive.png" 
                id="logo_hype">
        </div>
        
        <p>Hi <?php echo $username; ?>, Likha is requesting access to your 
            HypeHive credentials</p>
        <h3> Likha utilizes HypeHive credentials to personalize your 
            experience by:</h3>
        <ul>
        ...
        <ul>
            <li>Likha will only access the information necessary 
                ...
                above.</li>
            <li>Your HypeHive password will not be shared with Likha. 
